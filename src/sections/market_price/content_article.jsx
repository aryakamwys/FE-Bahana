  ...
  return (
    <div>
      ...
      <BlogArticle
        ...
        text={
          "Pada tanggal 24 Juni 2024, pasar pertanian di Indonesia menunjukkan beberapa perubahan signifikan, khususnya pada harga cabai merah keriting. Penurunan harga cabai merah keriting menjadi sorotan utama karena komoditas ini sering menjadi indikator fluktuasi harga di pasar sayuran. Dalam blog ini, kita akan membahas faktor-faktor yang menyebabkan penurunan harga cabai merah keriting, dampaknya pada petani dan konsumen."
        }
        time={"24 June 2024 ・6 min"}
      />
      <BlogArticle
