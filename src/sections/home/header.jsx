    ...
    <div className="bg-neutral">
      ...
      <div className="flex row-auto justify-between">
        <div className="flex flex-col">
          <div className="lg:w-[610px] lg:h-[255px] w-[164px] h-[78px] font-inter text-black font-bold text-start text-[22px] lg:text-[70px] lg:leading-normal ">
        ...
        <img
          src={GlobeImage}
          className="lg:w-[388px] lg:h-[296px] w-[165px] h-[144px] "
          alt="Globe"
        />
      </div>
    </div>
