    ...
    <div className="max-w-sm bg-white border border-black rounded-xl">
      ...
      <div className="p-[5px] lg:p-6">
        ...
        <div className="flex flex-row justify-between">
          <button
            className="w-[78px] h-[18px] lg:w-[261px] lg:h-[55px] flex flex-row justify-center items-center border-[1px] lg:border-2 border-gray border-opacity-50 rounded-full lg:pt-4 lg:pb-4"
