  ...
  return (
    <div className={`flex flex-col items-start ${paddingLeft}`}>
      ...
      <div className={className}>
        <div
          className={`h-[35px] lg:w-[292px] lg:h-[70px] md:w-[184px] md:h-[44px] flex flex-row justify-between items-center border-[1px] border-gray border-opacity-50 rounded-md lg:rounded-xl px-[10px] cursor-pointer`}
        ...
        {isOpen && (
          <div className="absolute w-full md:w-[184px] lg:w-[292px] mt-3 bg-white border border-gray rounded-lg lg:rounded-xl shadow-lg z-10 max-h-36 overflow-y-auto ">
            {options.map((option) => (
              <div
                key={option.value}
