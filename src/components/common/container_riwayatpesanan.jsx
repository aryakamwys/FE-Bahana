      ...
      <div className="flex flex-col">
        <div className="flex flex-row">
          ...
          <div className="flex flex-col items-start">
            <div
              className="font-inter font-semibold text-black text-[14px] md:text-[22px] lg:text-[30px] "
            >
              Nama product loren ipsum ddee
            </div>
            <div className="h-2"></div>
            <div
              className="text-start font-inter font-medium text-black text-[10px] md:text-[12px] lg:text-[17px] "
            >
            ...
            <div className="py-3">
              <div
                className="font-inter font-medium text-black pt-1 pb-1 px-[10px] md:px-[14px]  lg:px-4 border border-black rounded-md lg:rounded-xl text-[10px] md:text-[12px] lg:text-[20px] "
              >
                5 kg
              </div>
            </div>
          ...
          <div className="flex items-end lg:py-6">
            <div className="flex items-center justify-center py-[5px] px-[13px] md:px-[23px] md:py-[9px] lg:py-4 lg:px-12 border border-black rounded-md lg:rounded-xl hover:bg-primary hover:text-white w-[50px] h-[24px] md:w-[80px] md:h-[37px] lg:w-36 lg:h-14">
              <div className="font-inter font-medium text-black text-[12px] md:text-[16px] lg:text-[20px]">
                Nilai
              </div>
            </div>
          </div>
