...
const PlusMinusProduct = ({ quantity, maxQuantity, onQuantityChange }) => {
  ...
  return (
    <div className="py-[10px] md:py-[14px] lg:py-[20px] ">
      <div
        className="flex flex-row row-auto items-center font-medium font-inter text-[16px] lg:text-[25px] text-black w-[48px] h-[19px] md:w-[66px] md:h-[26px] lg:w-[135px] lg:h-[60px]"
      >
        <button
        ...
        <div
          className=" border border-gray border-opacity-50 text-[12px] md:text-[16px] lg:text-[28px] lg:px-[15px] py-[4] px-[7px] lg:py-[5px]"
        >
          {quantity}
        </div>
        <button
